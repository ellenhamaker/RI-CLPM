...
# Step 2
## Show full covariance matrix of the random intercepts. Check which indices you need to get the covariance matrix of the random intercepts. 
vcov(RICLPM.fit) # The 22nd and the 23rd indices are about the random intercepts
indices <- c(22, 23) 
