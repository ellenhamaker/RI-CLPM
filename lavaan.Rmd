...
Use the tabs below to navigate to the model specification of either the basic model, or the RI-CLPM with constraints over time. You can download the simulated example dataset *RICLPM.dat* [here](https://ellenhamaker.github.io/RI-CLPM/data/RICLPM.dat). 
...
Use the tabs below to navigate to the model specification of the basic multiple-group model, or the model with constrained lagged parameters. You can download the simulated example dataset *MGRICLPM.dat* [here](https://ellenhamaker.github.io/RI-CLPM/data/MGRICLPM.dat).
...
You can download the simulated example dataset *MIRICLPM.dat* [here](https://ellenhamaker.github.io/RI-CLPM/data/MIRICLPM.dat).
