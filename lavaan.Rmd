---
title: "Extensions of the RI-CLPM using Lavaan"
author: "Ellen L. Hamaker, & Jeroen D. Mulder"
...
# Load in the data. 
## Traditional RI-CLPM
## "/Users/jeroenmulder/SURFdrive/Research/TeacherCorner2019/RI-CLPM/RICLPM.dat"
## "C:/Users/5879167/surfdrive/Research/RI-CLPM/RI-CLPM/RICLPM.dat"
...
# Extension 1
## "/Users/jeroenmulder/SURFdrive/Research/TeacherCorner2019/RI-CLPMZ/RICLPMZ.dat"
## "C:/Users/5879167/surfdrive/Research/RI-CLPM/RI-CLPMZ/RICLPMZ.dat"
...
## Extension 2
## "/Users/jeroenmulder/SURFdrive/Research/TeacherCorner2019/MG RI-CLPM/MGRICLPM.dat"
## "C:/Users/5879167/surfdrive/Research/RI-CLPM/MG RI-CLPM/MGRICLPM.dat"
...
# Extension 3
## "/Users/jeroenmulder/SURFdrive/Research/TeacherCorner2019/MI RI-CLPM/MIRICLPM.dat"
## "C:/Users/5879167/surfdrive/Research/RI-CLPM/MI RI-CLPM/MIRICLPM.dat"
...
2. time-invariant (residual) (co-)variances in the within-person part,
...
## Extension 1: time-invariant predictor $z_{1}$ {.tabset}
...
1. random intercepts for each indicator separately.
2. constraints to ensure weak factorial invariance, and with a random intercept for each indicator separately.
3. constraints to ensure strong factorial invariance, with a random intercept for each indicator separately.
4. constraints to ensure strong factorial invariance, with a random intercept for each indicator separately, for which a factor model is specified, with factor loadings equal to the within-person factor loadings.
5. constraints to ensure strong factorial invariance and the RI-CLPM at the latent level.
...
```{r mi_ri-clpm_step_1.inp, results = F}
RICLPM1.ext3 <- '
...
```{r MI_RI-CLPM_step_2.inp, results = F}
RICLPM2.ext3 <- '
  ...
  # loadings over time.
  WFX1 =~ L1*x11 + L2*x12 + L3*x13
  WFX2 =~ L1*x21 + L2*x22 + L3*x23
  WFX3 =~ L1*x31 + L2*x32 + L3*x33
  WFX4 =~ L1*x41 + L2*x42 + L3*x43
  
  # Factor models for y at 4 waves.
  WFY1 =~ L4*y11 + L5*y12 + L6*y13
  WFY2 =~ L4*y21 + L5*y22 + L6*y23
  WFY3 =~ L4*y31 + L5*y32 + L6*y33
  WFY4 =~ L4*y41 + L5*y42 + L6*y43
...
```{r MI_RI-CLPM_step_3.inp, results = F}
RICLPM3.ext3 <- '
  ################
  # BETWEEN PART #
  ################
  ...
  # Factor models for x at 4 waves: constrained 
  ...
  # Factor models for y at 4 waves: constrained 
  # factor loadings over time. 
  WFY1 =~ L4*y11 + L5*y12 + L6*y13
  WFY2 =~ L4*y21 + L5*y22 + L6*y23
  WFY3 =~ L4*y31 + L5*y32 + L6*y33
  ...
  x11 + x21 + x31 + x41 ~ i1*1
  x12 + x22 + x32 + x42 ~ i2*1
  x13 + x23 + x33 + x43 ~ i3*1

  y11 + y21 + y31 + y41 ~ i4*1
  y12 + y22 + y32 + y42 ~ i5*1
  y13 + y23 + y33 + y43 ~ i6*1
...
```{r MI_RI-CLPM_step_4.inp, results = F}
RICLPM4.ext3 <- '
  ################
  # BETWEEN PART #
  ################
  ...
  RIX =~ L1*RIX1 + L2*RIX2 + L3*RIX3
  RIY =~ L4*RIY1 + L5*RIY2 + L6*RIY3
  ...
  # Factor models for y at 4 waves: constrained factor 
  # loadings over time. 
  WFY1 =~ L4*y11 + L5*y12 + L6*y13
  WFY2 =~ L4*y21 + L5*y22 + L6*y23
  WFY3 =~ L4*y31 + L5*y32 + L6*y33
...
RICLPM5.ext3 <- '
  ...
  # Factor models for x at 4 waves: constrained factor 
  # loadings over time.
  FX1 =~ L1*x11 + L2*x12 + L3*x13
  FX2 =~ L1*x21 + L2*x22 + L3*x23
  FX3 =~ L1*x31 + L2*x32 + L3*x33
  FX4 =~ L1*x41 + L2*x42 + L3*x43
  
  # Factor models for y at 4 waves: constrained factor 
  # loadings over time. 
  FY1 =~ L4*y11 + L5*y12 + L6*y13
  FY2 =~ L4*y21 + L5*y22 + L6*y23
  FY3 =~ L4*y31 + L5*y32 + L6*y33
  FY4 =~ L4*y41 + L5*y42 + L6*y43
