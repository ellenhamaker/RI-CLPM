...
Use the tabs below to navigate to the model specification of either the basic model, or the RI-CLPM with constraints over time. You can download the simulated example dataset *RICLPM.dat* [here](/RICLPM/data/RICLPM.dat). 
...
Use the tabs below to navigate to the model specification of the RI-CLPM with either $z_{1}$ as a predictor of the observed variables, or with $z_{1}$ as a predictor of the random intercepts. You can download the simulated example dataset *RICLPMZ.dat* [here](/RICLPM/data/RICLPMZ.dat).
...
Use the tabs below to navigate to the model specification of the basic multiple-group model, or the model with constrained lagged parameters. You can download the simulated example dataset *MGRICLPM.dat* [here](/RICLPM/data/MGRICLPM.dat).
...
You can download the simulated example dataset *MIRICLPM.dat* [here](/RICLPM/data/MIRICLPM.dat).
